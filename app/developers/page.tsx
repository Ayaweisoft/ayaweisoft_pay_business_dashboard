    ...
    <main className="bg-[#0B1220] text-white">
      ...
      <section className="text-center py-24 px-6">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <Link href="/register" className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl">
            Get API Keys
          </Link>
...

{
  ...
  "amount": 50000
      ...
      <section className="text-center py-24 px-6">
        ...
        <Link
          href="/register"
          className="px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl text-lg"
        >
          Create Free Account
        </Link>
      </section>
